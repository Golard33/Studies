 ...
 * 	Soit Tj un sommet non marqués dont tous les predecesseurs Tk sont marqué alors 
 * 		tj = max { tk + ex(Tk) }
 *  	Marquer Tj
 *  FinSoit
 * FinTantQue 
...
public class Algorithme {
	 ...
	 * cette méthode ne peut etre appelé qu'apres l'appel
	 * de la méthode {@link #calculeTempsAuPlusTot()}
	 * @return
	 */
